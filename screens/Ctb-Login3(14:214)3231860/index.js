...
export class Blank extends React.Component {
  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      <View style={styles.View_14_215}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/2d7e/f10e/5cae510b6e96372b6d5b598b5ce972d2"
          }}
          style={styles.ImageBackground_14_216}
        />
        <View style={styles.View_14_217}>
          <View source={{ uri: "null" }} style={styles.View_14_218} />
          <View style={styles.View_14_219}>
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/3287/ff5a/fd4fbb92d16681cad17307231c12c655"
              }}
              style={styles.ImageBackground_14_220}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_14_221}
            />
            <ImageBackground
              source={{
                uri:
            ...
            <ImageBackground
              ...
              style={styles.ImageBackground_14_227}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_14_230}
            />
          </View>
          <ImageBackground
            source={{
          ...
          <ImageBackground
            ...
            style={styles.ImageBackground_14_237}
          />
          <View style={styles.View_14_244}>
            <View style={styles.View_14_245}>
              <Text style={styles.Text_14_245}>12:30</Text>
            </View>
          </View>
        </View>
      </View>
      ...
      <View style={styles.View_14_247}>
        ...
        />
        <View style={styles.View_14_305}>
          <Text style={styles.Text_14_305}>Version 1.0.0</Text>
        </View>
      </View>
      <View style={styles.View_14_306}>
        <Text style={styles.Text_14_306}>Login Account</Text>
      </View>
      <View style={styles.View_14_307}>
        <View style={styles.View_14_308} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/7ec4/33c7/f4797b6eb183052f68c77ce7c86fec26"
          }}
          style={styles.ImageBackground_14_309}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_14_310}
        />
        <View style={styles.View_14_311}>
          <Text style={styles.Text_14_311}>AGENT_01</Text>
        </View>
      </View>
      <View style={styles.View_14_312}>
        <View style={styles.View_14_313} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/7ec4/33c7/f4797b6eb183052f68c77ce7c86fec26"
          }}
          style={styles.ImageBackground_14_314}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_14_315}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_14_316}
        />
        <View style={styles.View_14_324}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/58e9/af09/4fc85973be7f0018172113a17862a410"
            }}
            style={styles.ImageBackground_14_325}
          />
        </View>
      </View>
      <View style={styles.View_14_328}>
        <View style={styles.View_14_329} />
        <View style={styles.View_14_330}>
          <Text style={styles.Text_14_330}>LOGIN</Text>
        </View>
      </View>
      <ImageBackground
        source={{
        ...
        style={styles.ImageBackground_14_331}
      />
      <View style={styles.View_14_332}>
        <Text style={styles.Text_14_332}>Forgot your password?</Text>
      </View>
      <View style={styles.View_14_333}>
        <View style={styles.View_14_334}>
          <Text style={styles.Text_14_334}>CTB Mobile</Text>
        </View>
        <View style={styles.View_14_335}>
          <Text style={styles.Text_14_335}>Caring Transaction Based</Text>
        </View>
      </View>
      <View style={styles.View_14_336}>
        <View style={styles.View_14_337} />
        <View style={styles.View_14_338}>
          <Text style={styles.Text_14_338}>
            Login Failed! Your account is not found.
          </Text>
        </View>
        <ImageBackground
          source={{
          ...
          style={styles.ImageBackground_14_339}
        />
      </View>
...
const styles = StyleSheet.create({
  ...
  View_14_337: {
    ...
    left: wp("0%"),
    top: hp("0%"),
    backgroundColor: "rgba(245, 148, 34, 1)"
  },
  View_14_338: {

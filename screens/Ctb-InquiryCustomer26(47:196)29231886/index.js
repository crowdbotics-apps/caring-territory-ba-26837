  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      <View style={styles.View_47_197}>
        ...
        />
        <View style={styles.View_47_199}>
          <View source={{ uri: "null" }} style={styles.View_47_200} />
          <View style={styles.View_47_201}>
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/3287/ff5a/fd4fbb92d16681cad17307231c12c655"
              }}
              style={styles.ImageBackground_47_202}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_47_203}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_47_206}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_47_209}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_47_212}
            />
          </View>
          <ImageBackground
            source={{
            ...
            style={styles.ImageBackground_47_213}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_47_219}
          />
          <View style={styles.View_47_226}>
            <View style={styles.View_47_227}>
              <Text style={styles.Text_47_227}>12:30</Text>
            </View>
          </View>
        </View>
      </View>
      <View style={styles.View_47_228}>
        ...
        <ImageBackground
          ...
          style={styles.ImageBackground_47_231}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_47_232}
        />
      </View>
      <View style={styles.View_47_237}>
        <View style={styles.View_47_239}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/2d7e/f10e/5cae510b6e96372b6d5b598b5ce972d2"
            }}
            style={styles.ImageBackground_47_240}
          />
          <View style={styles.View_47_241}>
            <View source={{ uri: "null" }} style={styles.View_47_242} />
            <View style={styles.View_47_243}>
              <ImageBackground
                source={{
                  uri:
                    "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/3287/ff5a/fd4fbb92d16681cad17307231c12c655"
                }}
                style={styles.ImageBackground_47_244}
              />
              <ImageBackground
                source={{
                  uri:
                ...
                style={styles.ImageBackground_47_245}
              />
              <ImageBackground
                source={{
                  uri:
                ...
                style={styles.ImageBackground_47_248}
              />
              <ImageBackground
                source={{
                  uri:
            ...
            <ImageBackground
              ...
              style={styles.ImageBackground_47_255}
            />
            <ImageBackground
              source={{
                uri:
            ...
            <View style={styles.View_47_268}>
              <View style={styles.View_47_269}>
                <Text style={styles.Text_47_269}>12:30</Text>
              </View>
            </View>
          </View>
        </View>
        <View style={styles.View_47_270}>
          <View style={styles.View_47_271}>
            <Text style={styles.Text_47_271}>Detail Pelanggan</Text>
          </View>
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_47_272}
          />
        </View>
      </View>
      <View style={styles.View_47_295}>
        <View style={styles.View_47_296} />
        <View style={styles.View_47_297}>
          <Text style={styles.Text_47_297}>Phone: +62821345678</Text>
        </View>
        <View style={styles.View_47_298}>
          <Text style={styles.Text_47_298}>Whatsapp: +62821345678</Text>
        </View>
        <View style={styles.View_47_299}>
          <Text style={styles.Text_47_299}>
            Koordinat: -6.1777387,106.8263867
          </Text>
        </View>
        <View style={styles.View_47_300}>
          <Text style={styles.Text_47_300}>
            Alamat: Monas Selatan, Block 1, Kec. Pusat, 40288, Indonesia
          </Text>
        </View>
        <View style={styles.View_47_301}>
          <Text style={styles.Text_47_301}>Pelanggan Setia 1</Text>
        </View>
        <View style={styles.View_47_794}>
          <View style={styles.View_47_795}>
            <Text style={styles.Text_47_795}>Check Now &gt;&gt;</Text>
          </View>
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_47_796}
          />
        </View>
      </View>
      <View style={styles.View_47_302}>
        <View style={styles.View_47_303} />
        <View style={styles.View_47_304}>
          <View style={styles.View_47_305}>
            <View style={styles.View_47_306} />
            <View style={styles.View_47_307}>
              <View style={styles.View_47_308}>
                <View style={styles.View_47_309}>
                  <View style={styles.View_47_310} />
                  <View style={styles.View_47_311}>
                    <View style={styles.View_47_312}>
                      <Text style={styles.Text_47_312}>Visit Customer</Text>
                    </View>
                  </View>
                  <ImageBackground
                    source={{
                    ...
                    style={styles.ImageBackground_47_313}
                  />
                  <View style={styles.View_47_314}>
                    <View style={styles.View_47_315} />
                    <View style={styles.View_47_316}>
                      <Text style={styles.Text_47_316}>Done</Text>
                    </View>
                  </View>
                </View>
                <View style={styles.View_47_317}>
                  <View style={styles.View_47_318} />
                  <View style={styles.View_47_319}>
                    <View style={styles.View_47_320}>
                      <Text style={styles.Text_47_320}>
                  ...
                  <ImageBackground
                    ...
                    style={styles.ImageBackground_47_321}
                  />
                  <View style={styles.View_47_322}>
                    <View style={styles.View_47_323} />
                    <View style={styles.View_47_324}>
                      <Text style={styles.Text_47_324}>Done</Text>
                    </View>
                  </View>
                </View>
                <View style={styles.View_47_325}>
                  <View style={styles.View_47_326} />
                  <View style={styles.View_47_327}>
                    <View style={styles.View_47_328}>
                      <Text style={styles.Text_47_328}>Customer Agreement</Text>
                    </View>
                  </View>
                  <ImageBackground
                    source={{
                    ...
                    style={styles.ImageBackground_47_329}
                  />
                  <View style={styles.View_47_330}>
                    <View style={styles.View_47_331} />
                    <View style={styles.View_47_332}>
                      <Text style={styles.Text_47_332}>re-Confirm</Text>
                    </View>
                  </View>
                </View>
                <View style={styles.View_47_333} />
                <View style={styles.View_47_334}>
                  <View style={styles.View_47_335}>
                    <View style={styles.View_47_336}>
                      <Text style={styles.Text_47_336}>
                        Show QR/Link to Pay
                      </Text>
                    </View>
                  </View>
                  <ImageBackground
                    ...
                    style={styles.ImageBackground_47_337}
                  />
                  <View style={styles.View_47_338}>
                    <View style={styles.View_47_339} />
                    <View style={styles.View_47_340}>
                      <Text style={styles.Text_47_340}>Confirm</Text>
                    </View>
                  </View>
                </View>
                <View style={styles.View_47_341}>
                  <View style={styles.View_47_342} />
                  <View style={styles.View_47_343}>
                    <View style={styles.View_47_344}>
                      <Text style={styles.Text_47_344}>Payment Completed</Text>
                    </View>
                  </View>
                  <ImageBackground
                    source={{
                    ...
                    style={styles.ImageBackground_47_345}
                  />
                  <View style={styles.View_47_346}>
                    <View style={styles.View_47_347} />
                    <View style={styles.View_47_348}>
                      <Text style={styles.Text_47_348}>Confirm</Text>
                    </View>
                  </View>
                </View>
              </View>
            </View>
            <View style={styles.View_47_349} />
          </View>
          <View style={styles.View_47_350}>
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/f32c/dab8/046bf564b49806f9dff1c05f00b4cfc5"
              }}
              style={styles.ImageBackground_47_351}
            />
            <View style={styles.View_47_352}>
              <Text style={styles.Text_47_352}>Pick up</Text>
            </View>
          </View>
          <ImageBackground
            source={{
            ...
            style={styles.ImageBackground_47_353}
          />
        </View>
      </View>
      <ImageBackground
        ...
        style={styles.ImageBackground_47_354}
      />
      <View style={styles.View_47_356}>
        <View style={styles.View_47_357} />
        <View style={styles.View_47_358}>
          <Text style={styles.Text_47_358}>No. Invoice: 1/xx/2021/bil-1</Text>
        </View>
        <View style={styles.View_47_367}>
          <View style={styles.View_47_368} />
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/a9b4/d9d6/3443f8bdc20fe1c07b01bbbed18ceda1"
            }}
            style={styles.ImageBackground_47_369}
          />
        </View>
      </View>
      <View style={styles.View_47_370}>
        <View style={styles.View_47_371} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/1740/4bf4/888419e0c3fc9322805f1bb0ab8eaa99"
          }}
          style={styles.ImageBackground_47_372}
        />
        <View style={styles.View_47_373}>
          <Text style={styles.Text_47_373}>Upload Evidence</Text>
        </View>
        <View style={styles.View_47_374}>
          <Text style={styles.Text_47_374}>
            Please upload photo evidence that the customer has paid.
          </Text>
        </View>
        <View style={styles.View_47_402}>
          <View style={styles.View_47_400}>
            <Text style={styles.Text_47_400}>
              1 Photo bukti_lunas_pembayaran.png 100%
            </Text>
          </View>
          <ImageBackground
            source={{
            ...
            style={styles.ImageBackground_47_403}
          />
        </View>
        <View style={styles.View_47_375}>
          <View style={styles.View_47_376} />
          <View style={styles.View_47_377}>
            <View style={styles.View_47_378}>
              <Text style={styles.Text_47_378}>Pick from camera</Text>
            </View>
            <View style={styles.View_47_379}>
              <ImageBackground
                source={{
                  uri:
                    "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/a896/3e6c/7cb616ecfa316184054996e7b98c3dea"
                }}
                style={styles.ImageBackground_47_380}
              />
            </View>
          </View>
        </View>
        <ImageBackground
          ...
          style={styles.ImageBackground_47_384}
        />
        <View style={styles.View_47_385}>
          <View style={styles.View_47_386}>
            <Text style={styles.Text_47_386}>CANCEL</Text>
          </View>
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_47_387}
          />
        </View>
        <View style={styles.View_47_390}>
          <View style={styles.View_47_391}>
            <Text style={styles.Text_47_391}>YES</Text>
          </View>
          <View style={styles.View_47_392}>
            <View source={{ uri: "null" }} style={styles.View_47_393} />
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/6fcc/ebd6/0089cf09dfbf5726ad7b1ecca887234f"
              }}
              style={styles.ImageBackground_47_395}
            />
          </View>
        </View>
        <ImageBackground
          ...
          style={styles.ImageBackground_47_397}
        />
      </View>

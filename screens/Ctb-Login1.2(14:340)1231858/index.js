...
export class Blank extends React.Component {
  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      <View style={styles.View_14_341}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/2d7e/f10e/5cae510b6e96372b6d5b598b5ce972d2"
          }}
          style={styles.ImageBackground_14_342}
        />
        <View style={styles.View_14_343}>
          <View source={{ uri: "null" }} style={styles.View_14_344} />
          <View style={styles.View_14_345}>
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/3287/ff5a/fd4fbb92d16681cad17307231c12c655"
              }}
              style={styles.ImageBackground_14_346}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_14_347}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_14_350}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_14_353}
            />
            <ImageBackground
              source={{
                uri:
              ...
              style={styles.ImageBackground_14_356}
            />
          </View>
          <ImageBackground
            source={{
            ...
            style={styles.ImageBackground_14_357}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_14_363}
          />
          <View style={styles.View_14_370}>
            <View style={styles.View_14_371}>
              <Text style={styles.Text_14_371}>12:30</Text>
            </View>
          </View>
        </View>
      </View>
      <ImageBackground
        ...
        style={styles.ImageBackground_14_372}
      />
      <View style={styles.View_14_373}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/d106/33be/8a42168373fb727dd7040c4cd1c4587c"
          }}
          style={styles.ImageBackground_14_374}
        />
        <View style={styles.View_14_431}>
          <Text style={styles.Text_14_431}>Version 1.0.0</Text>
        </View>
      </View>
      <View style={styles.View_14_432}>
        <Text style={styles.Text_14_432}>Login Account</Text>
      </View>
      <View style={styles.View_14_433}>
        <View style={styles.View_14_434} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/7ec4/33c7/f4797b6eb183052f68c77ce7c86fec26"
          }}
          style={styles.ImageBackground_14_435}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_14_436}
        />
        <View style={styles.View_14_437}>
          <Text style={styles.Text_14_437}>AGENT_01</Text>
        </View>
      </View>
      <View style={styles.View_14_438}>
        <View style={styles.View_14_439} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/7ec4/33c7/f4797b6eb183052f68c77ce7c86fec26"
          }}
          style={styles.ImageBackground_14_440}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_14_441}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_14_442}
        />
        <View style={styles.View_14_450}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/58e9/af09/4fc85973be7f0018172113a17862a410"
            }}
            style={styles.ImageBackground_14_451}
          />
        </View>
      </View>
      <View style={styles.View_14_454}>
        <View style={styles.View_14_455} />
        <View style={styles.View_14_456}>
          <Text style={styles.Text_14_456}>LOGIN</Text>
        </View>
      </View>
      <ImageBackground
        source={{
        ...
        style={styles.ImageBackground_14_457}
      />
      <View style={styles.View_14_458}>
        <Text style={styles.Text_14_458}>Forgot your password?</Text>
      </View>
      <View style={styles.View_14_459}>
        <View style={styles.View_14_460}>
          <Text style={styles.Text_14_460}>CTB Mobile</Text>
        </View>
        <View style={styles.View_14_461}>
          <Text style={styles.Text_14_461}>Caring Transaction Based</Text>
        </View>
      </View>
      <View style={styles.View_15_2}>
        ...
        <View style={styles.View_15_8}>
          <ImageBackground
            ...
            style={styles.ImageBackground_15_3}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_15_4}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_15_5}
          />
          <View style={styles.View_15_6}>
            <Text style={styles.Text_15_6}>Loading</Text>
          </View>
        </View>
      </View>
